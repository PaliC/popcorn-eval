...
def _layer_norm_bwd_dwdb(DW,  # pointer to the partial sum of weights gradient
    ...
    # Calculate pid for block-level parallelism
    pid = tl.program_id(0)
    ...
    # Load partial gradients for weights and biases
    dw = tl.load(DW + offs_m * N + offs_n, mask=mask)
    db = tl.load(DB + offs_m * N + offs_n, mask=mask)
    
    # Reduction to sum across blocks
