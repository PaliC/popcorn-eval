...
@triton_heuristics.pointwise(size_hints=[8192,## to )

```python
@triton_heuristics.pointwise(size_hints=[256])

```python
@triton_heuristics.pointwise(size_hints=[64])

```python
@triton_heuristics.pointwise(size_hints=[128])

```python
@triton_heuristics.pointwise(size_hints=[1024])

```python
@triton_heuristics.pointwise(size_hints=[2048])

```python
@triton_heuristics.pointwise(size_hints=[4096])

```python
@triton_heuristics.pointwise(size_hints=[8192])

```python
@triton_heuristics.pointwise(size_hints=[16384])
