...
def _layer_norm_fwd(M,  # GROUP_SIZE_M
                   N,  # number of columns
                   X: tl.constexpr,  # pointer to the inputs
                   MEAN,  # pointer to the mean
                   VARIANCE,  # pointer to the variance
                   FINAL_MEAN,  # pointer to the final mean
                   FINAL_VARIANCE,  # pointer to the final variance
