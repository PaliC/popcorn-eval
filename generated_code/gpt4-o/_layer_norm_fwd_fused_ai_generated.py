...
def _layer_norm_fwd_fused(
    ...
    # Compute the row index for this program id
    row_start = pid * stride
    
    # Create a block index
    offsets = row_start + tl.arange(0, BLOCK_SIZE)
    
    # Mask for the block to handle boundaries
    ...
    # Compute variance and Rstd (1/std)
    ...
    y = x_hat * tl.load(W + offsets, mask=mask) + tl.load(B + offsets, mask=mask)
